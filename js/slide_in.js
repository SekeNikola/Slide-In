...
if(e.deltaY > 0)
  {
    if(moveFirstText.style.left == '0' || moveFirstText.style.left == '') moveFirstText.style.left = '-500px';
  }
  else
  {
...
if(e.deltaY > 0)
  {
    if(moveSecondText.style.left == '-500px' || moveSecondText.style.left == '') moveSecondText.style.left = '0';
  }
  else
  {
    if(moveSecondText.style.left == '0') moveSecondText.style.left = '-500px';
  }
